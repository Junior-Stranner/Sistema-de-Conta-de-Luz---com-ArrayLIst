...
public class Principal {
	...
	private static void mostrarLista(ArrayList <Luz> luz) {
		...
		for (Luz luz2 : luz) {
			...
			System.out.println(" Cep : "+luz2.getCep()
			+"\n Nome : "+luz2.getNome()
	...
	private static void consumidorPagar(ArrayList <Luz> luz) {
		...
		System.out.println(" Cep do Consumidor : ");
		int cep = Integer.parseInt(in.nextLine());
		...
		Luz l = new Luz(cep, nome ,valorLuz, horacConsumo,valorPagar);
